App({
  onLaunch: function() {
    ...
    wx.getSystemInfo({
      success: function(n) {
        o.globalData.isIpx = !(n.model.indexOf("iPhone X") < 0), o.globalData.systemInfo = n
      },
      fail: function(o) {},
      complete: function(o) {}
    })
  ...
  login: function(o) {
    ...
    wx.login({
      success: function(e) {
        var t = e.code;
        console.info("code >", t), n.globalData.code = t;
        try {
          var a = wx.getStorageSync("token"),
            r = wx.getStorageSync("userId"),
            i = wx.getStorageSync("userInfo");
          console.log("check token", a), console.log("check userId", r), console.log("check userInfo", i), a && r ? (n.globalData.token = a, n.globalData.userId = r, n.refreshUserProfile(function() {
  ...
  refreshUserProfile: function(o) {
    ...
    this.getRequest(this.globalData.BASE_URL + "/auth/profile", {}).then(function(e) {
      console.log("userInfo", e), n.globalData.userInfo = e, wx.setStorageSync("userInfo", e), o && "function" == typeof o && o()
    })
  },
    ...
    return new Promise(function(t, a) {
      wx.showNavigationBarLoading(), wx.request({
        ...
        complete: function(o) {
          ...
          "function" == typeof complete && complete(o), wx.hideNavigationBarLoading()
        })
      })
    })
  },
