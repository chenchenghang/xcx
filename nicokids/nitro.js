...
module.exports = {
  ...
  fetchProducts: function(o) {
    ...
    return r && s ? (console.info("fetchProducts() from local"), Promise.resolve().then(function() {
      ...
      var t = o[0],
        r = o[1];
      return e.globalData.categories = t, e.globalData.items = r, console.info("fetchProducts() from remote"), {
        categories: t,
        items: r
      }
    })
  ...
  payOrder: function(o) {
    wx.showLoading({
      ...
      console.info("pay charge", r), t.createPayment(r, function(t, s) {
        console.info("payment", t, s), "success" == t ? wx.showToast({
          title: "支付成功",
          icon: "success",
          duration: 2e3,
          success: function() {
          ...
          console.info("客户端撤销支付", e), wx.reLaunch({
            url: "/pages/orders/orders?reload=true"
          })
        }))
      })
